...
export const ko = {
  ...
  about: {
    keystone:
      '강의에서 다룬 Shor·Grover 알고리즘의 이론을 출발점으로, 본 프로젝트는 자원 추정 공식(RSA: Beauregard 2003·Gidney-Ekerå, ECC: Roetteler 2017)과 Willsch 2023의 최신 시뮬레이션 결과(평균 성공률 50%+)를 한국 50개 실제 인프라에 직접 적용하여, 도메인별 양자 깨짐 비용을 보수·실증 두 시나리오로 정량화한다.',
    context:
